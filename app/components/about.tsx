        ...
        >
          ...
          <div className="bg-zinc-900 text-gray-400 md:w-full md:col-span-1 px-10 md:px-20 py-10 md:text-lg text-sm text-center">
            <div className="flex flex-col h-full">
              <h2 className="text-lg lg:text-5xl uppercase mx-5 mt-0 mb-5 md:py-10 text-center font-extrabold from-yellow-500 via-yellow-100 to-blue-600 bg-gradient-to-r bg-clip-text text-transparent">
                {about.heading}
              </h2>
